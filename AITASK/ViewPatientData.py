...
class App(Frame):
    ...
    def CreateUI(self):
        ...
        tv.column('dov', anchor='center', width=100)
        tv.heading('cancer', text='Cancer')
        tv.column('cancer', anchor='center', width=100)
    ...
    def LoadTable(self):
        cursor = conn.cursor()
        sql = "SELECT * FROM BrainTumor.dbo.PatientInfo"
        cursor.execute(sql)
    ...
    def OnDoubleClick(self, event):
        ...
        printBtn = Button(root,text="Print",width=20,command=printData)
